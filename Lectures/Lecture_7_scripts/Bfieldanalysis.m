...
ylabel(h(1),'B_{max} (nT)','Interpreter','tex');
xlabel(h(1),'B_{min} (nT)','Interpreter','tex');
irf_zoom(h(1),'x',[-0.3 0.3])
irf_zoom(h(1),'y',[-0.3 0.3])

plot(h(2),Bibmmva.data(:,3),Bibmmva.data(:,2));
ylabel(h(2),'B_{int} (nT)','Interpreter','tex');
xlabel(h(2),'B_{min} (nT)','Interpreter','tex');
irf_zoom(h(2),'x',[-0.3 0.3])
irf_zoom(h(2),'y',[-0.3 0.3])

plot(h(3),Bibmmva.data(:,2),Bibmmva.data(:,1));
ylabel(h(3),'B_{max} (nT)','Interpreter','tex');
xlabel(h(3),'B_{int} (nT)','Interpreter','tex');
...
h(3)=irf_panel('Bfac2');
irf_plot(h(3),Bfacs);
ylabel(h(3),'B_{FAC} (nT)','Interpreter','tex');
