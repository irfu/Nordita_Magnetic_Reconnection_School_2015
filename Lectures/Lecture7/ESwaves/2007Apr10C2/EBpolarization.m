SCpos = c_caa_var_get('sc_pos_xyz_isr2__C2_CP_FGM_FULL_ISR2','caa','mat');
Bisr2=c_caa_var_get('B_vec_xyz_isr2__C2_CP_FGM_FULL_ISR2','caa','mat');
...
Bibm=c_caa_var_get('B_Vec_xyz_ISR2__C2_CP_EFW_L2_BB','caa','mat');
Eibm=c_caa_var_get('E_Vec_xy_ISR2__C2_CP_EFW_L2_EB','caa','mat');
...
polarization = irf_ebsp(Eibm,Bibm,Bisr2,Bisr2,SCpos,[10 2250],'polarization','fac');
