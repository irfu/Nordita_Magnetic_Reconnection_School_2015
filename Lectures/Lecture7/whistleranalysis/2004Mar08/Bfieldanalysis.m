...
tint1 = [irf_time([2004 03 08 16 03 21.0],'vector6>epoch') irf_time([2004 03 08 16 03 22.0],'vector6>epoch')]; % short time interval within internal burst interval
...
tint2 = [irf_time([2004 03 08 16 03 21.4],'vector6>epoch') irf_time([2004 03 08 16 03 21.5],'vector6>epoch')];
